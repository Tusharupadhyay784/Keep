...
function showItems() {
    task.forEach((value, index) => {
        ...
        img.addEventListener('click', () => {
            ...
            // h_one.style.fontWeight = "normal";
            // ps.style.fontWeight = "normal";
            // h_one.style.fontStyle = "normal"
            // ps.style.fontStyle = "normal"
            // h_one.style.color = "#000";
            // ps.style.color = "#000";
            // h_one.style.textTransform = "lowercase";
            // ps.style.textTransform = "lowercase";
            showItems();
        })
